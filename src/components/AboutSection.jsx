...
export default function About() {
    return (
        <section id='About'>
            <div>
                <h2>About Me</h2>
                <p>Hello! I'm Sylvia Tadross, a frontend developer with eight years of experience in UI development. I am from Cairo, Egypt but currently I live in Stockholm, Sweden. </p>
