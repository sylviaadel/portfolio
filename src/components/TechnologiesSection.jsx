    ...
    <>
      <section id="Technologies">
        <div>
          ...
          <ul>{knownTechnologyItems}</ul>
        </div>
        <div>
          <p>
            And here are the technologies that I have already learnt with Novare
            Potential.
          </p>
          <ul className="technologies-container">{newTechnologyItems}</ul>
        </div>
      </section>
      <TechnologiesModal
        tech={modalTech}
